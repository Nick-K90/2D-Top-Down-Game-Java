...
public class Sprite implements Comparable {
    ...
    /*
    Used by monsters in order to "decided" when to start chasing the player.
    Can't use radius because it depends on the sprites size.
     */
    ...
    private int type; //0 = NPC (including player), 1 = projectile
...
//    }
    ...
    public void setChasingRadius(float chasingRadius) {
    ...
    /**
     * 0 = NPC (including Player), 1 = Projectile
     * @param type 0 = NPC (including Player), 1 = Projectile
     */
    ...
    public int compareTo(Object s) {
        int comparezDepth=((Sprite)s).getzDepth();
        /* For Ascending order*/
        return this.zDepth-comparezDepth;

        //return comparezDepth - this.zDepth;
    }
    /**
