...
public abstract class GameCore extends JFrame implements KeyListener, MouseListener {
    ...
    public void gameLoop() {
        ...
        {
            /*
            Using volatile image. Much higher framerate in window mode but I couldn't make full screen mode work.
             */
            vImage = createVolatileImage(getWidth(), getHeight());
            bg = (Graphics2D)vImage.getGraphics();
        }
        else
        {
            /*
            Using buffered image for full screen. Low framerate in window mode however.
             */
        ...
        while (isRunning) {
            ...
            //Graphics2D g2 = screen.getGraphics();
	        ...
	        if (g != null)
	        {
	            ...
	            else
	            {
	            	...
	            	g.drawImage(vImage,0,0,getWidth(),getHeight(),null);
 	            }
            }
            else
            {
